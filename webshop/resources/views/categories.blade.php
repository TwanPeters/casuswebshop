                    ...
                    <div class="row" style=" background-color: white; padding: 50px; ">
                        ...
                        <div class="col-sm-4">
                            <a style="text-decoration: none;" href="https://www.bol.com/">
                                <div style=" border:black; border-style:solid; border-width:thin; margin-bottom:50px; background-color: orange; padding: 50px; text-align: center; text-decoration: none; ">{{($category->name)}}</div>
                            </a>
                        </div>
